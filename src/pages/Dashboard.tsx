...
export default function Dashboard() {
  return (
    <div className="container w-full mx-auto border-2">
      ...
      <div
        className={"flex justify-center gap-16 items-center flex-col h-screen"}
      >
        ...
        <div>
          <div className="bg-white border border-[#343434] p-2 rounded-md w-[19.2rem]">
            <div className="flex justify-between items-center">
              <span className="max-w-[30ch] block overflow-hidden text-ellipsis whitespace-nowrap">
                Make a backup of your current code to prevent any loss of work
              </span>
